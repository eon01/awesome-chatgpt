...
- [Tura](https://github.com/Tura-AI/tura): Free, open-source local coding agent with native OpenAI API support, custom OpenAI-compatible providers, and CLI, TUI, and desktop interfaces.
