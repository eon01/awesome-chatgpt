...
- [PORDL](https://www.npmjs.com/package/@plagtech/pordl): Smart LLM proxy that routes requests to the cheapest adequate model. Drop-in OpenAI replacement with npm SDK.
